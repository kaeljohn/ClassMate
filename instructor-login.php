...
<head>
    ...
    <title>ClassMate | Instructor Login</title>
    <link rel="icon" type="image/svg+xml" href="svg/favicon.svg">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="assets/fontawesome/css/all.min.css">
    <link rel="stylesheet" href="css/instructor-login.css">
</head>
<body>
...
<section class="login-container">
    <div class="login-box">
        ...
        <h2>Welcome Back</h2>
        <p class="subtitle">Log in to manage your classes</p>
        ...
        <p style="text-align:center; margin-top:20px; font-size:0.85rem; color:var(--text-muted);">
            New here? <a href="instructor-register.php" style="color:var(--primary); font-weight:700; text-decoration:none;">Create Account</a>
        </p>
    </div>
</section>
