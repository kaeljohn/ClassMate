...
if (isset($_GET['section_id'])) {
    ...
    // FIX: Using 'attendance_records' table to match the save script
    $sql = "SELECT student_id, week_number, status FROM attendance_records WHERE section_id = '$section_id'";
